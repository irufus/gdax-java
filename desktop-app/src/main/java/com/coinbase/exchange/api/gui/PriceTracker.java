...
public class PriceTracker {
    ...
    public static void main(String[] args) {
        System.setProperty(GdaxApiApplication.SYSTEM_PROPERTY_JAVA_AWT_HEADLESS, System.getProperty(GdaxApiApplication.SYSTEM_PROPERTY_JAVA_AWT_HEADLESS, Boolean.toString(false)));
