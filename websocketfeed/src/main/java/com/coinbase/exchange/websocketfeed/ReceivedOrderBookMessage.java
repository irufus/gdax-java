...
/**
 * A valid order has been received and is now active. This com.coinbase.exchange.api.websocketfeed.message is
 * emitted for every single valid order as soon as the matching engine
 * receives it whether it fills immediately or not.
 *
 * The received com.coinbase.exchange.api.websocketfeed.message does not indicate a resting order on the order book.
 * It simply indicates a new incoming order which as been accepted by the
 * matching engine for processing. Received orders may cause match com.coinbase.exchange.api.websocketfeed.message
 ...
 * canceled due to self-trade prevention result in an open com.coinbase.exchange.api.websocketfeed.message and
